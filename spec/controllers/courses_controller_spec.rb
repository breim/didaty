...
RSpec.describe CoursesController, type: :controller do
  ...
  let(:valid_attributes) {
    { name: 'Course Test', subtitle: 'Testing course', user_id: user.id, category_id: category.id }
  }

  let(:invalid_attributes) {
    { name: 'Course Test', subtitle: 'Testing course', user_id: user.id, category_id: nil }
  }
